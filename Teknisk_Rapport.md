...
Ett välanpassat färgschema påverkar besökarens känsla när hemsidan används. Ett varmare val av färger så som till exempel röd eller orange kan få användaren att känna spänning för hemsidans innehåll. Kalla färger som blått eller grönt kan däremot ha en lugnande effekt på hemsidan.  Som tidigare nämnts vill man ofta ha hög kontrast för ökad läsbarhet, då är det viktigt att kombinera ihop rätt färger med varandra. 
